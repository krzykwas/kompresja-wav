...
public class CompressedPacketImplTest {
    ...
    public void test_computeQuantizationLevels_generatesCorrectNumberOfLevels() {
        CompressedPacketImpl sut = new CompressedPacketImpl(Arrays.asList(new Double[]{1.0}), Arrays.asList(new Double[]{1.0, 2.0, 3.0}), Arrays.asList(new Sample[]{}));
    ...
    public void test_computeQuantizationLevels_generatesCorrect4Levels() {
        CompressedPacketImpl sut = new CompressedPacketImpl(Arrays.asList(new Double[]{1.0}), Arrays.asList(new Double[]{1.0, 2.0}), Arrays.asList(new Sample[]{}));
    ...
    public void test_compressErrors_packsValuesIntoOneLong() {
        ...
        CompressedPacketImpl sut = new CompressedPacketImpl(Arrays.asList(new Double[]{1.0}), errors, Arrays.asList(new Sample[]{}));
